...
static struct buffer_head * ext2_update_inode (struct inode * inode)
{
	...
	bh->b_dirt = 1;
	/* Ð´ÍêÖ®ºóinode¾Í²»ÊÇÔàµÄÁË£¬
	 * ×¢Òâ´ËÊ±inode²¢Ã»ÓÐÐ´µ½´ÅÅÌÉÏ£¬½ö½öÊÇÔÚ¸ßËÙ»º´æ
	 */
	inode->i_dirt = 0;  
	return bh;
}

/* ½ö½öÊÇÐ´µ½ÁË¸ßËÙ»º³å£¬ext2_sync_inodeº¯Êý²ÅÔÚÕâÖ®ºó½«ÄÚÈÝÐ´µ½ÁË´ÅÅÌ */
...
/* ½«inodeÊý¾ÝÏßÐ´Èëµ½¸ßËÙ»º´æ£¬È»ºó½«¸ßËÙ»º³åÖÐÊý¾ÝÐ´Èëµ½´ÅÅÌµ±ÖÐ */
